...
export const Questions = ({ questionsKey, onFinish }: QuestionsProps) => {
    ...
    const setUserAnswer = (answerId: string, isChecked: boolean | null) => {
        ...
        if (isChecked === null) {
            ...
            newAnswers[questionNumber].userAnswers = newAnswers[questionNumber].userAnswers.filter(
                (el) => el !== answerId,
            )
        }
        setAnswers(newAnswers)
                ...
                {answers[questionNumber].isDone && (
                    <>
                        ...
                        <div>
                            ...
                            <Link href={questions[questionNumber].answerDescription}>Read About</Link>
                        </div>
                    </>
                )}
            </Paper>
